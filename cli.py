...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="constant-time-crypto-verifier", description="Constant Time Crypto Verifier")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  CONSTANT TIME CRYPTO VERIFIER")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Constant Time Crypto Verifier Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Constant Time Crypto Verifier API server on http://{args.host}:{args.port}")
