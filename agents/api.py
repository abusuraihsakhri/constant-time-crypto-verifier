"""
FastAPI REST API Server for Constant Time Crypto Verifier.
"""
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "constant-time-crypto-verifier", "domain": "Post-Quantum Cryptography & Hardware Security", "standard": "NIST FIPS 203/204/205 / ISO/IEC 17825 Standards", "version": "3.0.0-ENTERPRISE"}
